...
description: Runs adaptive practice exams with grading and analytics. Use when the user asks for a practice test, wants to verify mastery, or is preparing for an exam.
---
